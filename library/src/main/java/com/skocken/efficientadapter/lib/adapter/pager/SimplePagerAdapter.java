...
/**
 * A concrete AbsViewHolderPagerAdapter that give you a list of homogeneous ViewHolder
 * @param <T> the king of object into this adapter
 */
public class SimplePagerAdapter<T> extends AbsViewHolderPagerAdapter<T> {
     ...
     */
    public SimplePagerAdapter(int layoutResId,
